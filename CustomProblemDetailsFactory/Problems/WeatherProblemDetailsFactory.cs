...
namespace CustomProblemDetailsFactory.Problems;

internal sealed class WeatherProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;
    private readonly Action<ProblemDetailsContext>? _configure;

    public WeatherProblemDetailsFactory(
